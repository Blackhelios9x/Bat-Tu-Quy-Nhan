// ========================================================
// MODULE TỬ VI – LÁ SỐ (SỬA LỖI MOBILE HOÀN CHỈNH)
// ========================================================
class TuViModule extends HTMLElement {
    ...
    if (typeof Solar !== 'undefined') {
      ...
      const check = setInterval(() => {
        if (typeof Solar !== 'undefined') {
          ...
          clearInterval(check);
          if (errorDiv) errorDiv.textContent = 'Không tải được thư viện. Vui lòng tải lại trang.';
        }
      }, 500);
    }
  }

  // ---------- CÁC HẰNG & HÀM GIỐNG HỆT FILE GỐC ----------
  ...
  // Copy toàn bộ hàm logic từ file cũ (tôi giữ nguyên ở đây)
  ...
  // Hàm tiện ích chuyển text thành số nguyên, trả về NaN nếu không hợp lệ
  _parseIntSafe(str) {
  ...
  _updateLaSo() {
    ...
    try {
      ...
      // Tiếp tục phần còn lại của _updateLaSo...
      // (Giữ nguyên toàn bộ logic như file cũ)

      // ... (phần còn lại đã ổn định)
